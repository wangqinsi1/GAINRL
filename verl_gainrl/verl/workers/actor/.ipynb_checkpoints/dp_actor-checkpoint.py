...
#===================================================================================                
                ...
                angle_metric=[]
                for last_tensor in chunks_list:
...
#===================================================================================
    ...
    def compute_log_prob(self, data: DataProto, calculate_entropy=False) -> torch.Tensor:
        ...
        for micro_batch in micro_batches:
            ...
            with torch.no_grad():
                entropy, log_probs, pro_data = self._forward_micro_batch(micro_batch, temperature=temperature, calculate_entropy=calculate_entropy)
                Angle_metric.extend(pro_data)
        ...
        return log_probs, entropys, Angle_metric
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    entropy, log_prob, pro_data = self._forward_micro_batch(micro_batch=data, temperature=temperature, calculate_entropy=calculate_entropy)
